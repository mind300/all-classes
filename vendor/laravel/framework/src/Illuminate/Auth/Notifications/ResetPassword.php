...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return $this->buildMailMessage($this->type == 'otp' ? $this->token : $this->resetUrl($notifiable));
    }
    ...
    protected function buildMailMessage($token)
    {
        if ($this->type == 'otp') {
            return (new MailMessage)
                ...
                ->line(Lang::get('Verification Code :code', ['code' => $token]))
                ->line(Lang::get('This Code will expire in :count minutes.', ['count' => config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')]))
